...
if($action === ACTION_INVENTORY ||
    ...
    $proxy = new SoapClient('https://store.shellybrown.com/api/v2_soap?wsdl=1');
    $sessionId = $proxy->login('sb_bracelets', 'O*#IJW15JRMPg^4v');
    ...
    switch ($action) {
        ...
        case ACTION_ADD_TO_CART:
            ...
            // set url
            curl_setopt($ch, CURLOPT_URL, "https://store.shellybrown.com/addbysku/index/index?skus=" . $products);
        ...
        case ACTION_DEBUG:
            ...
            $proxy = new SoapClient('https://store.shellybrown.com/api/soap/?wsdl');
            $session = $proxy->login('sb_bracelets', 'O*#IJW15JRMPg^4v');
